...
-- DROP FUNCTION IF EXISTS check_rental_period_constraints();
CREATE OR REPLACE FUNCTION check_rental_period_constraints()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
ALTER FUNCTION check_rental_period_constraints()
    OWNER TO postgres;
...
-- DROP TRIGGER IF EXISTS insert_constraints ON rental_period;
