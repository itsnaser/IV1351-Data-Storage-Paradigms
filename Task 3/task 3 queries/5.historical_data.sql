...
--#region [history]
CREATE TABLE soundgood.history (
 ...
 student_first_name VARCHAR(500) NOT NULL, 
 student_last_name VARCHAR(500) NOT NULL, 
 student_email VARCHAR(100) NOT NULL,
 UNIQUE(lesson_id,student_id)
);
ALTER TABLE soundgood.history ADD CONSTRAINT PK_lesson_history PRIMARY KEY (id);
--#endregion
