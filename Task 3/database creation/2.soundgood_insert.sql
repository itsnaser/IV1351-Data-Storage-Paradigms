...
INSERT INTO rental_period (student_id, instrument_id, rented_from, rented_until)
VALUES
-- Rentals that has been endded
(9, 4, '2024-03-01', '2024-09-01'),
(10, 5, '2024-04-01', '2024-10-01'),

-- Rentals active today
(11, 6, '2024-07-01', '2024-12-01'),
(12, 7, '2024-06-15', '2024-11-30'),
(13, 8, '2024-05-20', '2024-12-20'),
(14, 9, '2024-08-01', '2025-01-01'),
(15, 10, '2024-09-01', '2025-03-01'),

-- Rentals starting later
(16, 11, '2024-12-01', '2025-06-01'),
(17, 12, '2025-01-15', '2025-07-15'),
(18, 13, '2025-02-01', '2025-08-01'),
(19, 14, '2025-03-01', '2025-09-01'),
(20, 15, '2025-04-01', '2025-10-01'),

-- Same student with two active rentals (ensuring no conflict)
(16, 16, '2024-08-15', '2024-12-15'),
(17, 17, '2024-07-10', '2024-12-10'),

-- Additional rows ensuring variety
(18, 18, '2024-06-01', '2024-12-01'),
(19, 19, '2024-05-01', '2024-11-01'),
(20, 20, '2024-04-01', '2024-10-01'),

-- Students with two rentals that don't overlap
(21, 21, '2024-02-01', '2024-06-01'),
(21, 22, '2024-07-01', '2024-11-01'),
(22, 23, '2024-01-01', '2024-05-01'),
(22, 24, '2024-06-01', '2024-10-01'),
(23, 25, '2024-09-01', '2025-01-01'),
(23, 26, '2024-09-01', '2025-01-01');
--#endregion
